...
export function AnimatedScoreHubLogo() {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center overflow-hidden rounded-md mb-8">
      ...
      <div className="w-full max-w-md h-20 relative mt-4">
        ...
        {/* Radial Gradient to prevent sharp edges - Adapts to theme */}
        <div className={`absolute inset-0 w-full h-full ${
          isDark 
            ? "bg-background [mask-image:radial-gradient(300px_100px_at_top,transparent_20%,white)]" 
            : "bg-background [mask-image:radial-gradient(300px_100px_at_top,transparent_20%,black)]"
        }`}></div>
      </div>
